using System.Data;
using LedgerX.Api.Data;
using LedgerX.Api.Domain;
using LedgerX.Api.DTOs.Requests;
using LedgerX.Api.DTOs.Responses;
using LedgerX.Api.Exceptions;
using Microsoft.EntityFrameworkCore;

namespace LedgerX.Api.Services;
